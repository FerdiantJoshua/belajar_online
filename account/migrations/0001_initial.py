# Generated by Django 3.0.4 on 2020-04-15 00:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_teacher', models.BooleanField(default=0, help_text='Designates whether the user have teacher access.', verbose_name='Teacher status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.FileField(help_text='Only accepts pdfs', upload_to='account/document/cv/%Y%m%d', validators=[account.models.validate_file_extension], verbose_name='CV')),
                ('photos', models.ImageField(blank=True, null=True, upload_to='account/photos/%Y%m%d', verbose_name='Photos')),
