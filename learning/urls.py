...
urlpatterns = [
    ...
    path('booking/<int:pk>', views.BookingDetailView.as_view(), name='detail_booking'),
    path('booking/change_status/<booking_id>', views.change_status, name='change_status_booking'),
]
